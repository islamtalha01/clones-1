...
export default function Header({ onOpen }) {
  ...
  return (
    <header className="text-white body-font">
      <div className="containeronOpen mx-auto flex flex-wrap p-5 md:flex-row">
        <a
          className="flex title-font font-medium text-white mb-4 md:mb-0 pr-4"
          href="/"
        >
          <span className="ml-3 text-3xl">NINE4</span>
        </a>
        <button
        ...
        >
          <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center font-semibold pl-7">
            ...
            <Button
              className="mr-6 hover:text-white bg-transparent border-none cursor-pointer"
              // onClick={(e) => {
              //   e.preventDefault();
              //   onOpenChange();
              // }}
