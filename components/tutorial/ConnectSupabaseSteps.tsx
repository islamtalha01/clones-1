  ...
  return (
    <ol className='flex flex-col gap-6'>
      ...
      <Step title='Declare environment variables'>
        <p>
          Rename the{' '}
          <span className='px-2 py-1 rounded-md bg-foreground/20 text-foreground/80'>.env.example</span> file
          in your Next.js app to{' '}
          <span className='px-2 py-1 rounded-md bg-foreground/20 text-foreground/80'>.env.local</span> and
      ...
      <Step title='Restart your Next.js development server'>
        <p>
          ...
          <span className='px-2 py-1 rounded-md bg-foreground/20 text-foreground/80'>npm run dev</span> again
